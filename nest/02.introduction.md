...
That software will need a way to send messages over the Internet, so either it has its own way to do it, either it will use an existing library for that purpose.
